System.register(['../spine.ts', './atlas.ts', './render-ctx2d.ts', './render-webgl.ts'], function(exports_1) {
    "use strict";
    var spine, atlas, render_ctx2d_ts_1, render_webgl_ts_1, render_webgl_ts_2;
    function start() {
        ...
        var camera_zoom = 0.5;
        var enable_render_webgl = Boolean(gl);
        var enable_render_ctx2d = Boolean(ctx) && !enable_render_webgl;
